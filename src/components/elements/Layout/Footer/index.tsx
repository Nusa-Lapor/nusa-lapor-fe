      ...
      <div className="w-full max-w-[1440px] mx-auto h-auto min-h-96 relative">
        ...
        <div className="md:hidden p-8 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-3">
            <div className="pb-2">
              <div className="text-Text-Default-Default text-base font-semibold font-['Inter'] leading-snug">
                Partners Kami
              </div>
            </div>
            <a href="tel:112" target="_blank" rel="noreferrer" className="h-4">
              <div className="text-Text-Default-Default text-base font-normal font-['Inter'] leading-snug">
                Kontak Darurat Terpusat (112)
              </div>
            </a>
            <a
              href="https://jaki.jakarta.go.id/id/"
              target="_blank"
              rel="noreferrer"
              className="h-4"
            >
            ...
            <a
              href="https://pemadam.jakarta.go.id"
              target="_blank"
              rel="noreferrer"
              className="h-4"
            >
        ...
        <div className="hidden md:flex p-16 justify-between">
          ...
          <div
            ...
            className="w-64 inline-flex flex-col justify-start items-start gap-3"
          >
            <div className="self-stretch inline-flex justify-start items-start">
              <div className="justify-start text-Text-Default-Default text-base font-semibold font-['Inter'] leading-snug">
                Partners Kami
              </div>
            </div>
